...
provider.getBlockNumber().then(async (blockNumber) => {
  ...
  const f = await flashbotsProvider.sendBundle(
    [
      ...
      {
        signedTransaction:
          "0xf85f018082520894b97201736082824567552eb0c0f12110edf9ab1280801ca02c5a7eb8dc805a910786ace69d09fcde637e3b36762d7ceb1e16098be380f4cfa041d248e0e09d72254d7ad959d1e3f23bb662865c83e2f15bef23142eb6d922d4",
      },
      {
        signer: wallet,
        transaction: {
